...
import xyz.kiurchv.cull.worker.WorkerEntryPoint;

@Generated("dagger.hilt.processor.internal.root.RootProcessor")
public final class CullApplication_HiltComponents {
  private CullApplication_HiltComponents() {
  }
  ...
  public abstract static class SingletonC implements FragmentGetContextFix.FragmentGetContextFixEntryPoint,
      ...
      SingletonComponent,
      GeneratedComponent,
      CullApplication_GeneratedInjector,
      WorkerEntryPoint {
  }
  ...
  @Subcomponent(
      modules = {
          AlbumContentViewModel_HiltModules.KeyModule.class,
          AlbumsViewModel_HiltModules.KeyModule.class,
          ActivityCBuilderModule.class,
          ViewModelCBuilderModule.class,
          DuplicateGroupViewModel_HiltModules.KeyModule.class,
          GalleryViewModel_HiltModules.KeyModule.class,
          HiltWrapper_ActivityRetainedComponentManager_LifecycleModule.class,
          HiltWrapper_SavedStateHandleModule.class,
          PhotoViewerViewModel_HiltModules.KeyModule.class,
          SeriesViewModel_HiltModules.KeyModule.class,
          SettingsViewModel_HiltModules.KeyModule.class,
          TrashReviewViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          AlbumContentViewModel_HiltModules.BindsModule.class,
          AlbumsViewModel_HiltModules.BindsModule.class,
          DuplicateGroupViewModel_HiltModules.BindsModule.class,
          ...
          TrashReviewViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
